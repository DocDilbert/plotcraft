...
bool MyApp::OnInit() {
  ...
  plot_craft_.Plot(m_x, m_y_1,
                   {{"label", "Simplex noise 1 octave"}, {"color", "blue"}, {"markerstyle", "x"}});
  plot_craft_.Plot(m_x, m_y_2,
                   {{"label", "Simplex noise 2 octaves"}, {"color", "red"}, {"markerstyle", "s"}});
  plot_craft_.Plot(
      m_x, m_y_3, {{"label", "Simplex noise 4 octaves"}, {"color", "black"}, {"markerstyle", "+"}});
